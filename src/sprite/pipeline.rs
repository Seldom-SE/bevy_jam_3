use bevy::{
    ...
    render::{
        render_resource::{
            ...
            BlendState, BufferBindingType, ColorTargetState, ColorWrites, FragmentState, FrontFace,
            ...
            ShaderStages, ShaderType, SpecializedRenderPipeline, TextureAspect, TextureFormat,
    ...
    sprite::{SpritePipelineKey, SPRITE_SHADER_HANDLE},
};
...
impl FromWorld for SpritePipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let lights_layout = render_device.create_bind_group_layout(&BindGroupLayoutDescriptor {
            entries: &[BindGroupLayoutEntry {
                binding: 0,
                visibility: ShaderStages::FRAGMENT,
                ty: BindingType::Buffer {
                    ...
                    min_binding_size: Some(
                        bevy_ecs_tilemap::render::lights::LightsUniformData::min_size(),
                    ),
                },
                count: None,
            }],
